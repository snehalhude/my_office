                  ...
                  <tbody>
                   ...
                   /* print_r($row);*/
                    ...
                    <tr>
                      ...
                      <td><?= $row->phone ?></td>
                      <?php if($row->status == 0){ ?>
                      <td><a href="<?= site_url('Employee/change_status/'.$row->status.'/'.$row->id) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to change status? ')">Inactive</a></td>
                      <?php } else { ?>
                      <td><a href="<?= site_url('Employee/change_status/'.$row->status.'/'.$row->id) ?>" class="btn btn-xs btn-success" onclick="return confirm('Are you sure to change status? ')">Active</a></td>
                      <?php } ?>
                      <td>
